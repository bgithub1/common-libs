 ...
 *
 */
public class YahooFinanceCsvPdiWithFutQuery implements QueryInterface<Set<String>,Map<String, ComplexQueryResult<PriceDisplayInterface>>> {
	...
	public YahooFinanceCsvPdiWithFutQuery(Map<String,String> exchMap, Map<String,String> prodAssocMap){
