...
/**
 * use this model for pricing Eurodollar options
 * @author bperlman1
 *
 */
public class VanOptBachelierEd extends VanOptAbst {
	
	public VanOptBachelierEd(Calendar evaluationDate,
	...
	public double getVanillaPrice(double callput, double atm, double strike,
		...
		double ret = 
				BachelierEd.optPrice(callput, atm, strike, dte, vol, rate, div);
		return ret;
	}
	...
	public double getVanillaDelta(double callput, double atm, double strike,
			double dte, double vol, double rate, double div, Object[] others) {
		double ret = 
				BachelierEd.delta(callput, atm, strike, dte, vol, rate, div);
		return ret;
	}
	...
	public double getVanillaGamma(double callput, double atm, double strike,
			double dte, double vol, double rate, double div, Object[] others) {
		double ret = 
				BachelierEd.gamma(callput, atm, strike, dte, vol, rate, div);
		return ret;
	}
	...
	public double getVanillaVega(double callput, double atm, double strike,
			double dte, double vol, double rate, double div, Object[] others) {
		double ret = 
				BachelierEd.vega(callput, atm, strike, dte, vol, rate, div);
		return ret;
	}
	...
	public double getVanillaTheta(double callput, double atm, double strike,
			double dte, double vol, double rate, double div, Object[] others) {
		double ret = 
				BachelierEd.theta(callput, atm, strike, dte, vol, rate, div);
		return ret;
	}
	...
	public double getVanillaRho(double callput, double atm, double strike,
			double dte, double vol, double rate, double div, Object[] others) {
		double ret = 
				BachelierEd.rho(callput, atm, strike, dte, vol, rate, div);
		return ret;
	}
	...
	public double getVanillaDayDelta(double callput, double atm,
		...
		double ret = 
				BachelierEd.delta(callput, atm, strike, dte, vol, rate, div);
		ret = ret - 
				BachelierEd.delta(callput, atm, strike, dteOneDayForward, vol, rate, div);
		return ret;
