...
import com.billybyte.dse.queries.DefaultValues;
...
public class AtmFromPdiQuery implements QueryInterface<Set<String>, Map<String,ComplexQueryResult<BigDecimal>>>{
